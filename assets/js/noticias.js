...
function confirmarEliminar(idNoticia) {
    if (confirm("¿Estás seguro de que deseas eliminar esta noticia?")) {
        document.getElementById("deleteIdNoticia").value = idNoticia;
...
document.addEventListener("DOMContentLoaded", function() {
    // Verificar si hay una noticia para editar
    const editNoticia = document.querySelector('input[name="idNoticia"]');
    if (editNoticia) {
